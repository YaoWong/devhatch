...
export function InlineRename({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      requestAnimationFrame(() => container?.querySelector<HTMLElement>('button[aria-label^="Rename"], button[aria-label^="Path actions"]')?.focus());
    };
  }, []);
