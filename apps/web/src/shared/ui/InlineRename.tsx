...
export function InlineRename({
  ...
  return (
    ...
    >
      ...
      <span className="inline-rename-field tw:flex tw:h-6 tw:w-fit tw:min-w-0 tw:max-w-full tw:items-center tw:overflow-hidden tw:rounded-[6px] tw:border tw:border-input tw:bg-card tw:py-px tw:pr-0.5 tw:pl-1.5 tw:shadow-[0_1px_2px_rgb(var(--shadow-color)/6%)] tw:transition-[border-color,box-shadow] tw:duration-[140ms] tw:ease-[ease] tw:focus-within:border-[color-mix(in_srgb,var(--color-accent)_72%,var(--color-border-strong))] tw:focus-within:shadow-[0_0_0_2px_color-mix(in_srgb,var(--color-accent)_10%,transparent)] tw:[@media(pointer:coarse)]:in-[.repository-summary]:h-11 tw:[@media(pointer:coarse)]:in-[.profile-title]:h-11 tw:in-[.path-main]:h-4 tw:in-[.path-main]:pl-[5px]">
        <Input
          ref={inputRef}
          variant="bare"
          id={errorId}
