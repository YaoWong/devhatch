...
export function TerminalLayoutPresetControl({ count, value, onChange }: {
  ...
  return <div className="tw:ml-auto tw:flex tw:max-w-full tw:gap-0.5 tw:rounded-[9px] tw:border tw:border-border tw:bg-card tw:p-0.5 tw:[@media(pointer:coarse)]:max-w-[96px] tw:[@media(pointer:coarse)]:flex-wrap" role="group" aria-label={`${count} terminal layout`}>
